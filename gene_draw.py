...
class GeneImage(object):
    def __init__(self, gene_length, exon_intervals, ra_start_stop_codon, rb_start_stop_codon, exon_color="orange", bar_color='gray', bg_color="white", start_codon_color = "green", stop_codon_color = "red"):
